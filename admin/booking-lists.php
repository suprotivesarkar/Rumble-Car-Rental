...
$.post("helper/enq/booking",{"operation":"viewmore","id":button.data("id")},function(data){
$(".enqfull").html(data);
});
});
...
function fetchData(){$.post("helper/enq/booking",{"operation":"fetch"},function(data){$(".loadpan").html(data);$('#entry_table').DataTable({stateSave:true});});}
</script>
</body>
</html>